                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="select2 form-control custom-select"
                                                style="width: 100%; height:36px;" name="plant">
                                            <option>Select</option>
                                            <option value="0">BEGINNER PLANT</option>
                                            <option value="1">PREMIUM PLANT</option>
                                            <option value="2">ULTIMATE PLANT</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="select2 form-control m-t-15" multiple="multiple"
                                                style="height: 36px;width: 100%;" name="class_id[]">
                                            <?php foreach ($class as $item => $value): ?>
                                                <optgroup label="<?= $value->day_ ?>">
                                                    <?php
                                                    $m_class = new m_class();
                                                    $class_day = $m_class->read_class_by_day($value->day_);
                                                    foreach ($class_day as $item => $cl_day):
                                                        if ($cl_day->day_ == $value->day_):
                                                            ?>
                                                            <option value="<?= $cl_day->class_id ?>"><?= $cl_day->categorie_name ?>
                                                                - <?= $cl_day->time_ ?> - <?= $cl_day->day_ ?></option>
