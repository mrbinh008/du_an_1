(function ($) {
  ...
  var all_classes_slide = $('.all-classes-slider-two');
  all_classes_slide.owlCarousel({
    loop: true,
    margin: 15,
    autoplay: true,
  ...
  $('.all_classes_slide_nav_two .testi_next').on('click', function () {
    all_classes_slide.trigger('next.owl.carousel');
  });

  $('.all_classes_slide_nav_two .testi_prev').on('click', function () {
    all_classes_slide.trigger('prev.owl.carousel');
  });
