...
<head>
    ...
    <script src="assets/js/formPayment.js"></script>
    <link rel="stylesheet" href="assets/css/formPayment.css">
</head>
<body>
                    ...
                    <div class="d-flex" id="wrapper">
                        ...
                        <div class="bg-light border-right" id="sidebar-wrapper">
                            ...
                            <div class="list-group list-group-flush"> <a data-toggle="tab" href="#menu1" id="tab1" class="tabs list-group-item bg-light">
                                    ...
                                    <div class="list-div my-2">
                                        <div class="fa fa-credit-card"></div> &nbsp;&nbsp; Credit Card
                                    </div>
                                </a> <a data-toggle="tab" href="#menu3" id="tab3" class="tabs list-group-item bg-light">
                                    <div class="list-div my-2">
                                        <div class="fa fa-qrcode"></div> &nbsp;&nbsp;&nbsp; Pay via QR <span id="new-label">NEW</span>
                                    </div>
                                </a> </div>
                        </div> <!-- Page Content -->
